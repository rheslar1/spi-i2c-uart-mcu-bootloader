# SPI/I2C/UART MCU Bootloader Requirements

## Functional Requirements

| ID | Requirement | Verification |
| --- | --- | --- |
| FR-001 | The system shall expose a deterministic host-buildable runtime for SPI/I2C/UART MCU Bootloader. | CMake/CTest smoke run. |
| FR-002 | The system shall model the project focus: Bootloader that reprograms an MCU over UART, SPI, or I2C with packet framing, CRC checks, flash erase/write control, image validation, and recovery mode. | Scenario tests and documentation review. |
