...
This repository includes a structured design package for **SPI/I2C/UART MCU Bootloader**. The package captures the system boundary, runtime flow, hardware/software interfaces, validation strategy, and implementation roadmap.
